  ...
  constructor() {
    ...
    <div id="app-download">
        <div id="app-download-inner-container">
          ...
          <a id="app-download-button" href="https://play.google.com/store/apps/details?id=com.icomvision.bsc.tbc&hl=en">
          ...
          <div id="download-options">
            <a href="https://play.google.com/store/apps/details?id=com.icomvision.bsc.tbc&hl=en"><div class="download-option-button">
              <img src="../images/google-play.svg"/>
            </div></a>

            <a href="https://apps.apple.com/us/app/tbc-bank/id766598432"><div class="download-option-button">
